...
public class GetTXTFromHtml {


    public static String getMuLu(){
        String url = "https://www.tsxs.org/82/82563/";
        String encoding ="GBK";
    ...
    public static void insertOne(String title,String url){
        //String url = "https://www.tsxs.org/82/82563/32418903.html";
        String encoding ="GBK";
        String html = getHTMLResourceByUrl(url,encoding);
        ...
        Element element = document.getElementById("book_text");
        String result = element.text().replace("$$$$$", "\n");
        //result.replace("☆免费小说阅读 [www.tsxs.org ]更新快无弹窗☆","");
    ...
    public static void main(String[] args) {
        ...
        Element element = document.getElementsByClass("article_texttitleb").get(0);
        Elements ulList = element.getElementsByTag("ul");
        for (Element ul:ulList){
            Element li = ul.getElementsByTag("li").first();
            if(null!=li){
                Element a = li.getElementsByTag("a").first();
                String zhangJie = a.text();
                String url = "https://www.tsxs.org"+a.attr("href");
                insertOne(zhangJie,url);
            }
        }

    }

    private static String filePath = "D:\\楚倾歌风漓夜.txt";
