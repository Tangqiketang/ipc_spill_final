...
/*  一、假定密码字符数范围6-16，除英文数字和字母外的字符都视为特殊字符：
	...
	public static String getPassWordMd5(String passWord,String salt){
		...
		return DigestUtils.md5Hex(passWordMd5);
	}

	public static boolean comparePassWord(String passWordStored,String salt,String passWord){
		String passWordMd5 = DigestUtils.md5Hex(passWord+salt);
		String passWordCurrent = DigestUtils.md5Hex(passWordMd5);
		return passWordStored.equals(passWordCurrent);
	}
